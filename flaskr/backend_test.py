...
class TestBackend(unittest.TestCase):
    ...
    def test_signin_success(self):
        ...
        backend.sign_up('testuser', 'Password123@', 'testuser@test.com')
        ...
        mock_blob.open.return_value.__enter__.return_value.read.return_value = hashlib.md5(b'testpassword5gz').hexdigest()
    ...
    def test_signin_failure(self):
        ...
        self.backend.storage_client.bucket = Mock(return_value=Mock(blob=Mock(return_value=mock_blob)))
    ...
    def test_sign_up_success(self):
        ...
        self.backend.sign_up(user_name, password, email)
